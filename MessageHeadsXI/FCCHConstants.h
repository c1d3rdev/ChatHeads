 ...
 */
#define CHAT_HEAD_MARGIN_X              0.0

/**
 @brief vertical margin inside window or super view of chat heads.
 */
#define CHAT_HEAD_MARGIN_Y              [UIApplication sharedApplication].keyWindow.safeAreaInsets.top
...
#define NEGATIVE_SPACE (CHAT_HEAD_DIMENSION+CHAT_HEAD_MARGIN_Y)
 ...
 */
#define CHAT_HEAD_SINK_WIDTH            (SCREEN_BOUNDS.size.width*0.5)
 ...
 */
#define MAX_NUMBER_OF_CHAT_HEADS        6
