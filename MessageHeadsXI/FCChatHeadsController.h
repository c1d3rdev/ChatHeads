...
@property (nonatomic, assign) BOOL chatHeadsHidden;
@property (nonatomic, assign) BOOL isPresentingAlert;

@property CGRect DEFAULT_CHAT_HEAD_FRAME;
/**
...
/**
 @brief method for presenting a message from chat heads
 @param message string will be what the popover displays
 */
...
- (void)retryPopOverContextHosting;;
...
/**
 @brief called before popover for chat head is presented
 @param chController instance of FCChatHeadsController
 @param chatID unique identifier for chat head
 */
- (void)chatHeadsController:(FCChatHeadsController *)chController willPresentPopoverForChatID:(NSString *)chatID;
